...
.FN coef.l1celist
.TL
Use `coef()' on a `l1celist' object
.CS
coef.l1celist(object, all=T, constrained=F, ...)
.DN
...
If `all=F', then the coefficients that are zero in all fitted models
of the list are not returned.
