...
plot((2*(seq(1:20)-1)+10)/10,avgerror,type='l',col='blue',ylab='MSE',xlab=expression(lambda[1]),main = 'MSE for Group Lasso')
dev.off()

temp = grouplasso(100,0,p,n,y,X,truebeta,oldbeta,beta,blocksize,100,10^(-5),group.indx,weights,group)
y = temp$beta
x = temp$truebeta
